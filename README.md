...
- We default the covered bandwidth to 5MHz as a reasonable default for P25; 2MHz will almost always be too small, and 5MHz will typically be enough; large simulcast systems may require more, but it's a reasonable starting point. If instead, you're just using this for public service NBFM, 2MHz is probably going to be plenty; agencies will tend to use channels clustered in a small span, often below 0.5MHz.
