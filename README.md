...
- With NBFM, you might not need any gain at all; start with zero and see how it plays.
- With P25, increasing the gain will probably be warranted; in my case, I go up about 10 to 12 dB, or until the passband looks reasonable, without dishing at the low end. Excessive gain will not be beneficial.
