...
is never changed. Stored portable paths are not remapped. The success report can be copied and continues automatically
after its visible countdown; an unconfirmed failed replacement does not restart automatically.
