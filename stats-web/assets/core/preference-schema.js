  ...
  function validate(value) {
    ...
    return {
      ...
      playback: {
        ...
        target_grouping: bool(value.playback.target_grouping, 'playback.target_grouping'),
        target_burst_limit: number(value.playback.target_burst_limit, 1, 20,
          'playback.target_burst_limit', true)
      },
