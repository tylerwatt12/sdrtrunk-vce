...
/**
 * Scalar implementation of HydraSDR sample converter for un-packed samples.
 */
public class ScalarUnpackedSampleConverter implements IHydraSdrSampleConverter
{
    /**
    ...
    public short[] convert(ByteBuffer buffer)
    {
        ...
        if(shouldCalculateDc)
        {
            ...
            averageDcNow *= HydraSdrBufferIterator.SCALE_SIGNED_12_BIT_TO_FLOAT;
