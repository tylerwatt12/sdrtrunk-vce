...
/**
 * Vector implementation of HydraSDR sample converter for un-packed samples.
 */
public class VectorUnpackedSampleConverter implements IHydraSdrSampleConverter
{
