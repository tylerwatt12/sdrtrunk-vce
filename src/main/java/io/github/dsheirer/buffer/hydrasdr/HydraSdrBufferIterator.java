...
/**
 * Base complex samples iterator for raw HydraSDR sample buffers.  Incorporates a Hilbert transform filter
 * for converting the real sample array to complex samples.
 * @param <T> either ComplexSamples or InterleavedComplexSamples
 */
public abstract class HydraSdrBufferIterator<T> implements Iterator<T>
{
     ...
     * @param samples from the HydraSDR.
