    ...
    private static List<Column> columns(String dataset)
    {
        return switch(dataset)
        {
            ...
            case "conventional-talkgroups" -> List.of(
                ...
                number("encrypted_logical_calls", "encrypted_logical_call_count"),
                number("last_source_radio_id", "last_source_radio_id"),
            ...
            case "conventional-radios" -> List.of(
                ...
                number("target_logical_calls", "target_logical_call_count"),
                number("group_logical_calls", "group_logical_call_count"),
                number("private_logical_calls", "private_logical_call_count"),
                number("encrypted_logical_calls", "encrypted_logical_call_count"),
                number("last_talkgroup_id", "last_talkgroup_id"),
                text("last_talkgroup_alias", "last_talkgroup_alias_name"),
            ...
            case "aliases" -> List.of(
                ...
                number("stream_submitted_logical_calls", "stream_submitted_logical_call_count"),
                number("encrypted_logical_calls", "encrypted_logical_call_count"),
                number("grant_observations", "grant_observation_count"),
                number("join_observations", "join_observation_count"),
                number("emergency_observations", "emergency_observation_count"),
                number("registration_observations", "register_observation_count"),
                number("logout_observations", "logout_observation_count"),
