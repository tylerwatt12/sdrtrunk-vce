...
public record WebCallConfiguration(int maximumListeners, int maximumSelectedScanLists,
                                   int maximumBrowserQueueCalls, int maximumCachedCalls,
                                   @JsonProperty("maximum_cached_audio_mib") int maximumCachedAudioMiB)
{
    ...
    public static final int DEFAULT_MAXIMUM_BROWSER_QUEUE_CALLS = 100;
    ...
    public static final int MINIMUM_BROWSER_QUEUE_CALLS = 1;
    public static final int MAXIMUM_BROWSER_QUEUE_CALLS = 500;
    ...
    public WebCallConfiguration
    {
        ...
        maximumBrowserQueueCalls = clamp(maximumBrowserQueueCalls, MINIMUM_BROWSER_QUEUE_CALLS,
            MAXIMUM_BROWSER_QUEUE_CALLS);
    ...
    public static WebCallConfiguration defaults()
    {
        return new WebCallConfiguration(DEFAULT_MAXIMUM_LISTENERS, DEFAULT_MAXIMUM_SELECTED_SCAN_LISTS,
            DEFAULT_MAXIMUM_BROWSER_QUEUE_CALLS, DEFAULT_MAXIMUM_CACHED_CALLS,
