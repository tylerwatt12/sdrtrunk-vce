...
/**
 * RSP1B Composite parameters (device and tuner)
 *
 * Note: RSP1B uses RSP1A device and tuner parameters structures.
 */
public class Rsp1bCompositeParameters extends CompositeParameters<Rsp1aDeviceParameters, Rsp1aTunerParameters>
{
    /**
     ...
     */
    public Rsp1bCompositeParameters(Version version, MemorySegment deviceParams, Arena arena)
    {
        super(version, DeviceType.RSP1B, deviceParams, arena, Rsp1aDeviceParameters.class, Rsp1aTunerParameters.class);
    }
}
