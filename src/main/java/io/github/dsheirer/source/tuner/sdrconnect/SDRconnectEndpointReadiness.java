...
class SDRconnectEndpointReadiness
{
    ...
    static SDRconnectEndpointReadiness ready(String validDevices)
    {
        return new SDRconnectEndpointReadiness(true, validDevices);
    }

    static SDRconnectEndpointReadiness notReady()
    {
