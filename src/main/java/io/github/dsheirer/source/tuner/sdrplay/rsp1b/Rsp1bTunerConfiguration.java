...
/**
 * RSP1B tuner configuration
 */
public class Rsp1bTunerConfiguration extends RspTunerConfiguration
{
     ...
     */
    public Rsp1bTunerConfiguration(String uniqueId)
    {
        super(uniqueId);
    }
     ...
     */
    public Rsp1bTunerConfiguration()
    {
    }
