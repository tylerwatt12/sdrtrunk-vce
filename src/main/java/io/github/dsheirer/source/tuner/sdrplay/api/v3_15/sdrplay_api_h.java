...
public class sdrplay_api_h {
    ...
    private static final int RSPDX_NUM_LNA_STATES_AMPORT2_12_50 = (int)20L;
    /**
     * {@snippet lang=c :
    ...
    public static int RSPDX_NUM_LNA_STATES_AMPORT2_12_50() {
        return RSPDX_NUM_LNA_STATES_AMPORT2_12_50;
    }
    private static final int RSPDX_NUM_LNA_STATES_AMPORT2_50_60 = (int)25L;
    /**
     * {@snippet lang=c :
    ...
    public static int RSPDX_NUM_LNA_STATES_AMPORT2_50_60() {
        return RSPDX_NUM_LNA_STATES_AMPORT2_50_60;
    }
    ...
    private static final int RSPDX_NUM_LNA_STATES_DX = (int)22L;
    /**
     * {@snippet lang=c :
    ...
    private static final int sdrplay_api_DeviceFailure = (int)4L;
    /**
     * {@snippet lang=c :
     * enum <anonymous>.sdrplay_api_DeviceFailure = 4
     * }
     */
    public static int sdrplay_api_DeviceFailure() {
        return sdrplay_api_DeviceFailure;
    }
    /**
     * {@snippet lang=c :
     * typedef void *HANDLE
    ...
    private static final int sdrplay_api_Update_RspDuo_ResetSlaveFlags = (int)64L;
    /**
     * {@snippet lang=c :
     * enum <anonymous>.sdrplay_api_Update_RspDuo_ResetSlaveFlags = 64
     * }
     */
    public static int sdrplay_api_Update_RspDuo_ResetSlaveFlags() {
        return sdrplay_api_Update_RspDuo_ResetSlaveFlags;
    }
    ...
    private static class sdrplay_api_GetLastErrorByType {
        public static final FunctionDescriptor DESC = FunctionDescriptor.of(
            sdrplay_api_h.C_POINTER,
            sdrplay_api_h.C_POINTER,
            sdrplay_api_h.C_INT,
        ...
        public static final MemorySegment ADDR = sdrplay_api_h.findOrThrow("sdrplay_api_GetLastErrorByType");
     ...
     * }
     */
    public static FunctionDescriptor sdrplay_api_GetLastErrorByType$descriptor() {
        return sdrplay_api_GetLastErrorByType.DESC;
    }
     ...
     * }
     */
    public static MethodHandle sdrplay_api_GetLastErrorByType$handle() {
        return sdrplay_api_GetLastErrorByType.HANDLE;
    }
     ...
     * }
     */
    public static MemorySegment sdrplay_api_GetLastErrorByType$address() {
        return sdrplay_api_GetLastErrorByType.ADDR;
    }
    ...
    public static MemorySegment sdrplay_api_GetLastErrorByType(MemorySegment device, int type, MemorySegment time) {
        var mh$ = sdrplay_api_GetLastErrorByType.HANDLE;
        try {
            if (TRACE_DOWNCALLS) {
                traceDowncall("sdrplay_api_GetLastErrorByType", device, type, time);
            }
            return (MemorySegment)mh$.invokeExact(device, type, time);
        } catch (Throwable ex$) {
           throw new AssertionError("should not reach here", ex$);
        }
    }
    ...
    public static int sdrplay_api_SwapRspDuoDualTunerModeSampleRate(MemorySegment dev, MemorySegment currentSampleRate, double newSampleRate) {
        ...
        try {
            if (TRACE_DOWNCALLS) {
                traceDowncall("sdrplay_api_SwapRspDuoDualTunerModeSampleRate", dev, currentSampleRate, newSampleRate);
            }
    ...
    private static final float SDRPLAY_API_VERSION = 3.1500000953674316f;
    /**
     * {@snippet lang=c :
     * #define SDRPLAY_API_VERSION 3.1500000953674316
     * }
     */
    ...
    private static final int SDRPLAY_RSP1B_ID = (int)6L;
    /**
     * {@snippet lang=c :
    ...
    private static final int SDRPLAY_RSPdxR2_ID = (int)7L;
    /**
     * {@snippet lang=c :
     * #define SDRPLAY_RSPdxR2_ID 7
     * }
     */
    public static int SDRPLAY_RSPdxR2_ID() {
