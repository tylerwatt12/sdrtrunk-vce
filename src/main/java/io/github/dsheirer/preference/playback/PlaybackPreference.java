...
public class PlaybackPreference extends Preference
{
    ...
    {
        this(updateListener, Preferences.userNodeForPackage(PlaybackPreference.class));
    }

    /**
     * Constructs this preference against the supplied store for isolated tests.
     */
    PlaybackPreference(Listener<PreferenceType> updateListener, Preferences preferences)
    {
