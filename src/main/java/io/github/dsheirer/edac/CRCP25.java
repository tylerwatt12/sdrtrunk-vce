...
public class CRCP25
{
     ...
     */
    private static final int[] CCITT_80_CHECKSUMS = new int[]
        {
     ...
     */
    private static final int[] CRC9_CHECKSUMS = new int[]
        {
     ...
     */
    private static final long[] PDU1_CHECKSUMS = new long[]
        {
     ...
     */
    private static final long[] PDU2_CHECKSUMS = new long[]
        {
     ...
     */
    private static final long[] PDU3_CHECKSUMS = new long[]
        {
