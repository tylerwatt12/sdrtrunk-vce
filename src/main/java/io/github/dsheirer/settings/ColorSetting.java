...
public class ColorSetting extends Setting
{
    ...
    public enum ColorSettingName
    {
        ...
        AUDIO_CHANNEL_BACKGROUND(Color.BLACK, NO_TRANSLUCENCY, "Audio Background", "Audio Channel Background Color"),
        AUDIO_CHANNEL_LABEL(Color.LIGHT_GRAY, NO_TRANSLUCENCY, "Audio Label", "Audio Channel Label Color"),
        AUDIO_CHANNEL_MUTED(Color.RED, NO_TRANSLUCENCY, "Audio Muted", "Audio Channel Muted Color"),
        AUDIO_CHANNEL_VALUE(Color.GREEN, NO_TRANSLUCENCY, "Audio Value", "Audio Channel Value Color"),
