...
public class BroadcastifyCallEditor extends AbstractBroadcastEditor<BroadcastifyCallConfiguration>
{
     ...
     * @param configurationManager for accessing the broadcast model
     */
    public BroadcastifyCallEditor(ConfigurationManager configurationManager)
    {
        super(configurationManager, BroadcastifyCallConfiguration.class);
    }
