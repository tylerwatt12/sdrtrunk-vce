...
public class AliasViewByRecordingEditor extends VBox
{
    ...
    public AliasViewByRecordingEditor(ConfigurationManager configurationManager)
    {
    ...
    private FilteredList<Alias> getNoRecordFilteredList()
    {
        ...
        {
            mNoRecordFilteredList = new FilteredList<>(mConfigurationManager.getAliasModel().aliasList(),
    ...
    private FilteredList<Alias> getRecordFilteredList()
    {
        ...
        {
            mRecordFilteredList = new FilteredList<>(mConfigurationManager.getAliasModel().aliasList(),
                getRecordPredicate());
        }
