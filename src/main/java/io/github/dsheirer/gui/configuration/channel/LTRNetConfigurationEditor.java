...
import io.github.dsheirer.gui.configuration.decoder.AuxDecoderConfigurationEditor;
...
public class LTRNetConfigurationEditor extends ChannelConfigurationEditor
{
     ...
     */
    public LTRNetConfigurationEditor(ConfigurationManager configurationManager, TunerManager tunerManager,
        ...
        if(mDecoderPane == null)
        {
            ...
            mDecoderPane.expandedProperty().addListener((observable, oldValue, newValue) -> {
                ...
                if(newValue && getDirectionButton().getToggleGroup().getSelectedToggle() == null &&
                    getItem().getDecodeConfiguration() instanceof DecodeConfigLTRNet decodeConfig)
                {
