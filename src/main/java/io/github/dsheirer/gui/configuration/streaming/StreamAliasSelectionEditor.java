...
public class StreamAliasSelectionEditor extends VBox
{
     ...
     * @param configurationManager for access to alias model
     */
    public StreamAliasSelectionEditor(ConfigurationManager configurationManager)
    {
    ...
    private FilteredList<Alias> getAvailableFilteredList()
    {
        ...
        {
            mAvailableFilteredList = new FilteredList<>(mConfigurationManager.getAliasModel().aliasList(),
    ...
    private FilteredList<Alias> getSelectedFilteredList()
    {
        ...
        {
            mSelectedFilteredList = new FilteredList<>(mConfigurationManager.getAliasModel().aliasList(),
