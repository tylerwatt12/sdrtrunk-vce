...
public class StreamingEditor extends SplitPane
{
     ...
     * @param configurationManager for accessing streaming model
     */
    public StreamingEditor(ConfigurationManager configurationManager)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                if(editorType == null || editorType != configType)
                {
                    ...
                    if(editor == null)
                    {
                        editor = StreamEditorFactory.getEditor(configType, mConfigurationManager);
    ...
    private StreamAliasSelectionEditor getStreamAliasSelectionEditor()
    {
        ...
        {
            mStreamAliasSelectionEditor = new StreamAliasSelectionEditor(mConfigurationManager);
        }
        ...
        if(mDeleteButton == null)
        {
            ...
            mDeleteButton.setOnAction(event -> {
                ...
                if(config != null)
                {
                    ...
                    {
                        mConfigurationManager.getBroadcastModel().removeBroadcastConfiguration(config);
                    }
                }
            });
        }
    ...
    private TableView<ConfiguredBroadcast> getConfiguredBroadcastTableView()
    {
        if(mConfiguredBroadcastTableView == null)
        {
            ...
            mConfiguredBroadcastTableView.setItems(mConfigurationManager.getBroadcastModel().getConfiguredBroadcasts());
    ...
    public class CreateBroadcastifyMenuItem extends MenuItem
    {
        ...
        public CreateBroadcastifyMenuItem(UserFeedBroadcast userFeedBroadcast)
        {
            ...
            setOnAction(event -> {
                ...
                {
                    ConfiguredBroadcast configuredBroadcast = mConfigurationManager.getBroadcastModel()
