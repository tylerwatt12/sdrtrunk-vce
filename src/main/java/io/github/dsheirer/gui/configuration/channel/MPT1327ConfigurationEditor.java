...
public class MPT1327ConfigurationEditor extends ChannelConfigurationEditor
{
     ...
     */
    public MPT1327ConfigurationEditor(ConfigurationManager configurationManager, TunerManager tunerManager,
    ...
    private ComboBox<ChannelMap> getChannelMapComboBox()
    {
        if(mChannelMapComboBox == null)
        {
            ...
            mChannelMapComboBox.setItems(getConfigurationManager().getChannelMapModel().getChannelMaps());
            mChannelMapComboBox.setDisable(true);
