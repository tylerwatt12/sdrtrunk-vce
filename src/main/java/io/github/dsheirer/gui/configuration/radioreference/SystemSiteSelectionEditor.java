...
public class SystemSiteSelectionEditor extends GridPane
{
     ...
     * @param configurationManager to access radio reference
     */
    public SystemSiteSelectionEditor(UserPreferences userPreferences, ConfigurationManager configurationManager)
    {
    ...
    private SiteEditor getSiteEditor()
    {
        if(mSiteEditor == null)
        {
            mSiteEditor = new SiteEditor(mUserPreferences, mConfigurationManager);
        }
