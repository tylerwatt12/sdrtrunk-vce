...
public class AliasViewByIdentifierEditor extends VBox
{
    ...
    public AliasViewByIdentifierEditor(ConfigurationManager configurationManager, ReadOnlyBooleanProperty tabSelectedProperty)
    {
    	aliasListInvalidated = false;
        mConfigurationManager = configurationManager;
        //Note if aliases change since we're using a static snapshot
        mConfigurationManager.getAliasModel().aliasList().addListener((InvalidationListener)observable -> aliasListInvalidated = true);
    ...
    private void updateList()
    {
        ...
        List<Alias> aliases = mConfigurationManager.getAliasModel().getAliases(aliasList, type);
