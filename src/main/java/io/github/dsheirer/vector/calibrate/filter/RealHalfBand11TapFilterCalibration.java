...
/** Selects the fastest correct 11-tap real half-band decimation filter for the current CPU. */
public class RealHalfBand11TapFilterCalibration extends AbstractRealHalfBandFilterCalibration
{
    public RealHalfBand11TapFilterCalibration()
    {
        super(CalibrationType.FILTER_HALF_BAND_REAL_11_TAP, 11, false);
    }
    ...
    protected IRealDecimationFilter createFilter(Implementation implementation, float[] coefficients)
    {
        return switch(implementation)
        {
            ...
            case VECTOR_SIMD_64 -> new VectorRealHalfBandDecimationFilter11Tap64Bit(coefficients);
            case VECTOR_SIMD_128 -> new VectorRealHalfBandDecimationFilter11Tap128Bit(coefficients);
            case VECTOR_SIMD_256 -> new VectorRealHalfBandDecimationFilter11Tap256Bit(coefficients);
            case VECTOR_SIMD_512 -> new VectorRealHalfBandDecimationFilter11Tap512Bit(coefficients);
            default -> throw new IllegalArgumentException("Unsupported 11-tap implementation: " + implementation);
        };
    }
}
