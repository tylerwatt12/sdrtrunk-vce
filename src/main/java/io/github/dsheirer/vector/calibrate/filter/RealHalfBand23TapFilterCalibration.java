...
/** Selects the fastest correct 23-tap real half-band decimation filter for the current CPU. */
public class RealHalfBand23TapFilterCalibration extends AbstractRealHalfBandFilterCalibration
{
    public RealHalfBand23TapFilterCalibration()
    {
        super(CalibrationType.FILTER_HALF_BAND_REAL_23_TAP, 23, false);
    }
    ...
    protected IRealDecimationFilter createFilter(Implementation implementation, float[] coefficients)
    {
        return switch(implementation)
        {
            ...
            case VECTOR_SIMD_64 -> new VectorRealHalfBandDecimationFilter23Tap64Bit(coefficients);
            case VECTOR_SIMD_128 -> new VectorRealHalfBandDecimationFilter23Tap128Bit(coefficients);
            case VECTOR_SIMD_256 -> new VectorRealHalfBandDecimationFilter23Tap256Bit(coefficients);
            case VECTOR_SIMD_512 -> new VectorRealHalfBandDecimationFilter23Tap512Bit(coefficients);
            default -> throw new IllegalArgumentException("Unsupported 23-tap implementation: " + implementation);
        };
    }
}
