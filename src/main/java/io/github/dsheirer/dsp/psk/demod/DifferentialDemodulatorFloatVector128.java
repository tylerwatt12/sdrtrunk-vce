 ...
 */
public class DifferentialDemodulatorFloatVector128 extends DifferentialDemodulatorFloat
{
     ...
     */
    public DifferentialDemodulatorFloatVector128(double sampleRate, int symbolRate)
    {
