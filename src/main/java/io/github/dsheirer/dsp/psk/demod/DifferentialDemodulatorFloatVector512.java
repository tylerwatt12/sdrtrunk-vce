 ...
 */
public class DifferentialDemodulatorFloatVector512 extends DifferentialDemodulatorFloat
{
     ...
     */
    public DifferentialDemodulatorFloatVector512(double sampleRate, int symbolRate)
    {
