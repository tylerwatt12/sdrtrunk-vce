 ...
 */
public class DifferentialDemodulatorFloatVector256 extends DifferentialDemodulatorFloat
{
     ...
     */
    public DifferentialDemodulatorFloatVector256(double sampleRate, int symbolRate)
    {
