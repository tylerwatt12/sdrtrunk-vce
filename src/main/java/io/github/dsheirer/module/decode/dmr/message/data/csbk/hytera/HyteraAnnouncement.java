...
/**
 * Hytera DMR Tier III - Announcement Message
 */
public class HyteraAnnouncement extends CSBKMessage
{
    ...
    public String toString()
    {
        ...
        sb.append(" P1:").append(getParams1().toHexString());
        sb.append(" P2:").append(getParams2().toHexString());
    ...
    {
        return getMessage().getSubMessage(PARAMS_1_START, PARAMS_1_END);
    }

    public BinaryMessage getParams2()
    {
        return getMessage().getSubMessage(PARAMS_2_START, PARAMS_2_END);
    }
