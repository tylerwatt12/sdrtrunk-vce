...
/**
 * Motorola Unknown/Unrecognized opcode message.
 */
public class UnknownMotorolaISPMessage extends VendorOSPMessage
{
    /**
     * Constructs a TSBK from the binary message sequence.
     */
    public UnknownMotorolaISPMessage(P25P1DataUnitID dataUnitId, CorrectedBinaryMessage message, int nac, long timestamp)
    {
