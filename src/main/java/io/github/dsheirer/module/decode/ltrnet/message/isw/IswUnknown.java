 ...
 * ISW Unknown Message.
 */
public class IswUnknown extends LtrNetIswMessage
{
    /**
     * Constructs a message
     */
    public IswUnknown(CorrectedBinaryMessage message, long timestamp)
    {
    ...
    public String toString()
    {
        ...
        sb.append("ISW UNKNOWN MESSAGE - AREA:").append(getArea(getMessage()));
