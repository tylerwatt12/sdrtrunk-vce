...
public class AMBTCUnitToUnitAnswerResponse extends AMBTCMessage implements IServiceOptionsProvider
{
    private static final IntField HEADER_SERVICE_OPTIONS = IntField.length8(64);
    private static final IntField HEADER_ANSWER_RESPONSE = IntField.length8(72);
    private static final IntField BLOCK_0_WACN = IntField.length20(8);
    private static final IntField BLOCK_0_SYSTEM = IntField.length12(28);
    private static final IntField BLOCK_0_TARGET_ID = IntField.length24(40);
    ...
    public AMBTCUnitToUnitAnswerResponse(PDUSequence PDUSequence, int nac, long timestamp)
    {
    ...
    {
        if(mAnswerResponse == null)
        {
            mAnswerResponse = AnswerResponse.fromValue(getHeader().getMessage().getInt(HEADER_ANSWER_RESPONSE));
        }
