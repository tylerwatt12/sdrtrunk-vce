...
{
    private static final IntField TX_MULTIPLIER = IntField.length2(30);
     ...
     */
    public RadioUnitMonitorRequest(P25P1DataUnitID dataUnitId, CorrectedBinaryMessage message, int nac, long timestamp)
    {
