...
/**
 * Roaming address request
 */
public class RoamingAddressRequest extends ISPMessage
{
     ...
     */
    public RoamingAddressRequest(P25P1DataUnitID dataUnitId, CorrectedBinaryMessage message, int nac, long timestamp)
    {
