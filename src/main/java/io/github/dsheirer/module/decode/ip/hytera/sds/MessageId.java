 ...
 * Message Identifier
 */
public class MessageId extends HyteraToken
{
     ...
     */
    public MessageId(CorrectedBinaryMessage message)
    {
        super(message);
    }
    ...
    public String toString()
    {
        ...
        sb.append("MESSAGE ID:").append(getId());
        return sb.toString();
    }
    ...
    {
        return HyteraTokenType.ID_MESSAGE;
    }
}
