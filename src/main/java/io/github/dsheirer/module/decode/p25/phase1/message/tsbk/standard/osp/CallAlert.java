...
public class CallAlert extends OSPMessage
{
     ...
     */
    public CallAlert(P25P1DataUnitID dataUnitId, CorrectedBinaryMessage message, int nac, long timestamp)
    {
    ...
    public Identifier getSourceId()
    {
        if(mSourceId == null)
        {
            mSourceId = APCO25RadioIdentifier.createFrom(getMessage().getInt(SOURCE_ID));
        }
