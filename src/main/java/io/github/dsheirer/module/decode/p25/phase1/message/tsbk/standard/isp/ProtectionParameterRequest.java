...
/**
 * Protection parameter request
 */
public class ProtectionParameterRequest extends ISPMessage
{
     ...
     */
    public ProtectionParameterRequest(P25P1DataUnitID dataUnitId, CorrectedBinaryMessage message, int nac, long timestamp)
    {
