...
/**
 * Encryption initialization vector base message
 */
public abstract class InitializationVector extends NXDNLayer3Message
{
     ...
     * @param lich info
     */
    public InitializationVector(CorrectedBinaryMessage message, long timestamp, NXDNMessageType type, int ran, LICH lich)
    {
