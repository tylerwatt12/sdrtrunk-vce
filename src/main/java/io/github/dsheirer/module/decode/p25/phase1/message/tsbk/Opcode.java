...
public enum Opcode
{
     ...
     */
    public static final Set<Opcode> STANDARD_OUTBOUND_OPCODES = Set.copyOf(EnumSet.range(OSP_GROUP_VOICE_CHANNEL_GRANT,
            OSP_RESERVED_3F));

    /**
     * ISP standard opcodes
     */
    public static final Set<Opcode> STANDARD_INBOUND_OPCODES = Set.copyOf(EnumSet.range(ISP_GROUP_VOICE_SERVICE_REQUEST,
        ISP_RESERVED_3F));

    /**
     * ISP mobile data requests
     */
    public static final Set<Opcode> MOBILE_DATA_REQUESTS = Set.copyOf(EnumSet.of(ISP_INDIVIDUAL_DATA_SERVICE_REQUEST,
            ISP_GROUP_DATA_SERVICE_REQUEST, ISP_SNDCP_DATA_CHANNEL_REQUEST, ISP_SNDCP_RECONNECT_REQUEST));

    /**
     * ISP mobile voice requests
     */
    public static final Set<Opcode> MOBILE_VOICE_REQUESTS = Set.copyOf(EnumSet.of(ISP_GROUP_VOICE_SERVICE_REQUEST,
     ...
     */
    public static final Set<Opcode> MOBILE_REQUEST_RESPONSE = Set.copyOf(EnumSet.of(ISP_UNIT_TO_UNIT_ANSWER_RESPONSE,
     ...
     */
    public static final Set<Opcode> NETWORK_DATA_GRANTS = Set.copyOf(EnumSet.of(OSP_SNDCP_DATA_CHANNEL_GRANT,
            OSP_INDIVIDUAL_DATA_CHANNEL_GRANT, OSP_GROUP_DATA_CHANNEL_GRANT));

    /**
     * OSP network status
     */
    public static final Set<Opcode> NETWORK_CHANNEL_STATUS = Set.copyOf(EnumSet.of(OSP_GROUP_DATA_CHANNEL_ANNOUNCEMENT,
     ...
     */
    public static final Set<Opcode> NETWORK_COMMAND_REQUEST_RESPONSE = Set.copyOf(EnumSet.of(OSP_UNIT_TO_UNIT_ANSWER_REQUEST,
     ...
     */
    public static final Set<Opcode> NETWORK_VOICE_GRANTS = Set.copyOf(EnumSet.of(OSP_GROUP_VOICE_CHANNEL_GRANT,
     ...
     * Motorola opcodes
     */
    public static final Set<Opcode> MOTOROLA = Set.copyOf(EnumSet.of(MOTOROLA_ISP_UNKNOWN,
     ...
     * Harris opcodes
     */
    public static final Set<Opcode> HARRIS = Set.copyOf(EnumSet.of(HARRIS_ISP_UNKNOWN, HARRIS_OSP_GRG_EXENC_CMD,
            HARRIS_OSP_UNKNOWN));

    /**
     * Unknown vendor ISP/OSP opcodes
     */
    public static final Set<Opcode> UNKNOWN = Set.copyOf(EnumSet.of(UNKNOWN_VENDOR_ISP, UNKNOWN_VENDOR_OSP));
