...
public class UnitDeRegistrationAcknowledge extends OSPMessage
{
     ...
     */
    public UnitDeRegistrationAcknowledge(P25P1DataUnitID dataUnitId, CorrectedBinaryMessage message, int nac, long timestamp)
    {
    ...
    public Identifier getTargetAddress()
    {
        ...
        {
            mTargetAddress = APCO25RadioIdentifier.createTo(getMessage().getInt(TARGET_ID));
        }
