...
public class AMBTCTelephoneInterconnectChannelGrant extends AMBTCMessage implements IFrequencyBandReceiver, IServiceOptionsProvider
{
    ...
    private static final IntField BLOCK_0_CALL_TIMER = IntField.length16(32);
    ...
    public AMBTCTelephoneInterconnectChannelGrant(PDUSequence PDUSequence, int nac, long timestamp)
    {
