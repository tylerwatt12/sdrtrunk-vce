 ...
 */
public class GroupDataChannelGrant extends OSPMessage implements IFrequencyBandReceiver
{
     ...
     */
    public GroupDataChannelGrant(P25P1DataUnitID dataUnitId, CorrectedBinaryMessage message, int nac, long timestamp)
    {
