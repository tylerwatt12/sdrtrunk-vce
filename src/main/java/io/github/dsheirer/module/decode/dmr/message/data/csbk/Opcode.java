...
public enum Opcode
{
    ...
    STANDARD_UNIFIED_DATA_TRANSPORT_OUTBOUND_HEADER(Vendor.STANDARD, 26, Labels.UNIFIED_DATA_TRANSPORT_OUTBOUND_HEADER),
    STANDARD_UNIFIED_DATA_TRANSPORT_INBOUND_HEADER(Vendor.STANDARD, 27, Labels.UNIFIED_DATA_TRANSPORT_INBOUND_HEADER),
    ...
    STANDARD_UNIFIED_DATA_TRANSPORT_FOR_DGNA_OUTBOUND_HEADER(Vendor.STANDARD, 36,
            Labels.UNIFIED_DATA_TRANSPORT_OUTBOUND_HEADER),
    STANDARD_UNIFIED_DATA_TRANSPORT_FOR_DGNA_INBOUND_HEADER(Vendor.STANDARD, 37,
            Labels.UNIFIED_DATA_TRANSPORT_INBOUND_HEADER),
    ...
    {
        private static final String UNIFIED_DATA_TRANSPORT_OUTBOUND_HEADER = "UNIFIED DATA TRANSPORT OUTBOUND HEADER";
        private static final String UNIFIED_DATA_TRANSPORT_INBOUND_HEADER = "UNIFIED DATA TRANSPORT INBOUND HEADER";
     ...
     */
    public static final Set<Opcode> DATA_CHANNEL_GRANTS = Collections.unmodifiableSet(EnumSet.of(STANDARD_PRIVATE_DATA_CHANNEL_GRANT_MULTI_ITEM,
     ...
     * Data opcodes
     */
    public static final Set<Opcode> DATA_OPCODES = Collections.unmodifiableSet(EnumSet.of(STANDARD_UNIFIED_DATA_TRANSPORT_OUTBOUND_HEADER,
     ...
     */
    public static final Set<Opcode> MOBILE_REQUEST_RESPONSE = Collections.unmodifiableSet(EnumSet.of(STANDARD_UNIT_TO_UNIT_VOICE_SERVICE_REQUEST,
            STANDARD_RANDOM_ACCESS_SERVICE_REQUEST));

    /**
     * Network request and response and announcement opcodes
     */
    public static final Set<Opcode> NETWORK_REQUEST_RESPONSE = Collections.unmodifiableSet(EnumSet.of(STANDARD_FEATURE_NOT_SUPPORTED,
     ...
     */
    public static final Set<Opcode> VOICE_CHANNEL_GRANTS = Collections.unmodifiableSet(EnumSet.of(STANDARD_PRIVATE_VOICE_CHANNEL_GRANT,
     ...
     * Hytera opcodes
     */
    public static final Set<Opcode> HYTERA = Collections.unmodifiableSet(EnumSet.of(HYTERA_08_ACKNOWLEDGE, HYTERA_08_ANNOUNCEMENT,
     ...
     */
    public static final Set<Opcode> MOTOROLA_CAPACITY_MAX = Collections.unmodifiableSet(EnumSet.of(MOTOROLA_CAPMAX_ALOHA));

    /**
     * Motorola Capacity Plus opcodes
     */
    public static final Set<Opcode> MOTOROLA_CAPACITY_PLUS = Collections.unmodifiableSet(EnumSet.of(MOTOROLA_CAPPLUS_CALL_ALERT,
     ...
     */
    public static final Set<Opcode> MOTOROLA_CONNECT_PLUS = Collections.unmodifiableSet(EnumSet.of(MOTOROLA_CONPLUS_NEIGHBOR_REPORT,
