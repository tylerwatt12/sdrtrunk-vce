...
public class AMBTCIndividualDataServiceRequest extends AMBTCMessage
{
    ...
    public AMBTCIndividualDataServiceRequest(PDUSequence PDUSequence, int nac, long timestamp)
    {
