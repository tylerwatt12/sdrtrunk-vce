 ...
 */
public class StatusQueryRequest extends ISPMessage
{
     ...
     */
    public StatusQueryRequest(P25P1DataUnitID dataUnitId, CorrectedBinaryMessage message, int nac, long timestamp)
    {
