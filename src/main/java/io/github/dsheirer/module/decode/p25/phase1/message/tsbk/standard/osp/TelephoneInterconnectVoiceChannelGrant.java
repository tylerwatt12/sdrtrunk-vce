 ...
 */
public class TelephoneInterconnectVoiceChannelGrant extends OSPMessage implements IFrequencyBandReceiver, IServiceOptionsProvider
{
     ...
     */
    public TelephoneInterconnectVoiceChannelGrant(P25P1DataUnitID dataUnitId, CorrectedBinaryMessage message, int nac, long timestamp)
    {
