 ...
 */
public class LCChannelIdentifierUpdate extends LinkControlWord implements IFrequencyBand
{
    private static final IntField FREQUENCY_BAND_IDENTIFIER = IntField.length4(OCTET_1_BIT_8);
    private static final FragmentedIntField BANDWIDTH = FragmentedIntField.of(12, 13, 14, 15, 16, 17, 18, 19, 20);
    private static final int TRANSMIT_OFFSET_SIGN = 21;
    private static final FragmentedIntField TRANSMIT_OFFSET = FragmentedIntField.of(22, 23, 24, 25, 26, 27, 28, 29);
     ...
     * @param message
     */
    public LCChannelIdentifierUpdate(CorrectedBinaryMessage message)
    {
        super(message);
    }
