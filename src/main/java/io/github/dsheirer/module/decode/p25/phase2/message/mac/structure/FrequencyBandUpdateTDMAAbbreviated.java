...
/**
 * Identifier update (frequency band) - TDMA bands
 */
public class FrequencyBandUpdateTDMAAbbreviated extends MacStructure implements IFrequencyBand
{
     ...
     */
    public FrequencyBandUpdateTDMAAbbreviated(CorrectedBinaryMessage message, int offset)
    {
