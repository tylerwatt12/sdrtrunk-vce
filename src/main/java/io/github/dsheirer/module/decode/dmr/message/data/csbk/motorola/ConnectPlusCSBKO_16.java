...
/**
 * Connect Plus - CSBK 16 Message
 */
public class ConnectPlusCSBKO_16 extends CSBKMessage
{
     ...
     * @param timeslot
     */
    public ConnectPlusCSBKO_16(DMRSyncPattern syncPattern, CorrectedBinaryMessage message, CACH cach, SlotType slotType, long timestamp, int timeslot)
    {
