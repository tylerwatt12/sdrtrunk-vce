 ...
 */
public class UnknownHarrisISPMessage extends OSPMessage
{
    /**
     * Constructs a TSBK from the binary message sequence.
     */
    public UnknownHarrisISPMessage(P25P1DataUnitID dataUnitId, CorrectedBinaryMessage message, int nac, long timestamp)
    {
