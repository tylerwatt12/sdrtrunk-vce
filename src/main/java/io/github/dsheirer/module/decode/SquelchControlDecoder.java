...
/**
 * Primary decoder that adds the following functionality over the basic decoder:
 *
 * - Provides audio squelch control
 */
public abstract class SquelchControlDecoder extends PrimaryDecoder implements ISquelchStateProvider
{
