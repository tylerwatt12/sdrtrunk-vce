...
/**
 * Hytera DMR Tier III - CSBKO 32 - Possibly Acknowledge Response
 *
 ...
 */
public class Hytera08Acknowledge extends CSBKMessage
{
     ...
     * @param timeslot
     */
    public Hytera08Acknowledge(DMRSyncPattern syncPattern, CorrectedBinaryMessage message, CACH cach, SlotType slotType, long timestamp, int timeslot)
    {
    ...
    public String toString()
    {
        ...
        if(getReason() == Reason.UNKNOWN)
        {
            sb.append("UNKNOWN REASON CODE:").append(getMessage().getInt(REASON_CODE));
        }
        else
        {
            sb.append(getReason());
