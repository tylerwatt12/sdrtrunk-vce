 ...
 */
public class RoamingAddressCommand extends ISPMessage
{
    private static final IntField STACK_OPERATION = IntField.length8(16);
    private static final IntField WACN = IntField.length20(24);
    private static final IntField SYSTEM = IntField.length12(44);
    private static final IntField TARGET_ID = IntField.length24(56);
     ...
     */
    public RoamingAddressCommand(P25P1DataUnitID dataUnitId, CorrectedBinaryMessage message, int nac, long timestamp)
    {
    ...
    public String toString()
    {
        ...
        sb.append(" STACK OPERATION:").append(getStackOperation());
    ...
    {
        if(mStackOperation == null)
        {
            mStackOperation = StackOperation.fromValue(getMessage().getInt(STACK_OPERATION));
        }
