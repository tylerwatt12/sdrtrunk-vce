...
/**
 * Individual data service request.
 */
public class IndividualDataServiceRequest extends ISPMessage implements IServiceOptionsProvider
{
     ...
     */
    public IndividualDataServiceRequest(P25P1DataUnitID dataUnitId, CorrectedBinaryMessage message, int nac, long timestamp)
    {
