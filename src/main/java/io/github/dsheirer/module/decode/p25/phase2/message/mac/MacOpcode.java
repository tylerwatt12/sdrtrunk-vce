...
public enum MacOpcode
{
     ...
     */
    public static final Set<MacOpcode> MULTI_FRAGMENT = Set.copyOf(EnumSet.of(PHASE1_71_AUTHENTICATION_DEMAND,
     ...
     * Call maintenance
     */
    public static final Set<MacOpcode> CALL_MAINTENANCE = Set.copyOf(EnumSet.of(PUSH_TO_TALK, END_PUSH_TO_TALK,
     ...
     * Data channel grants
     */
    public static final Set<MacOpcode> DATA_GRANTS = Set.copyOf(EnumSet.of(PHASE1_54_SNDCP_DATA_CHANNEL_GRANT));

    /**
     * Mobile requests and responses
     */
    public static final Set<MacOpcode> MOBILE_REQUEST_RESPONSE = Set.copyOf(EnumSet.of(PHASE1_41_GROUP_VOICE_SERVICE_REQUEST,
     ...
     */
    public static final Set<MacOpcode> NETWORK_REQUEST_RESPONSE = Set.copyOf(EnumSet.of(TDMA_00_NULL_INFORMATION_MESSAGE,
     ...
     */
    public static final Set<MacOpcode> NETWORK_STATUS = Set.copyOf(EnumSet.of(PHASE1_70_SYNCHRONIZATION_BROADCAST,
     ...
     */
    public static final Set<MacOpcode> VOICE_GRANTS = Set.copyOf(EnumSet.of(TDMA_05_GROUP_VOICE_CHANNEL_GRANT_UPDATE_MULTIPLE_IMPLICIT,
