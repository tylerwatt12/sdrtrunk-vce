 ...
 */
public class UnitRegistrationRequest extends ISPMessage
{
    private static final int EMERGENCY_FLAG = 16;
    private static final IntField CAPABILITY = IntField.range(17, 23);
     ...
     */
    public UnitRegistrationRequest(P25P1DataUnitID dataUnitId, CorrectedBinaryMessage message, int nac, long timestamp)
    {
