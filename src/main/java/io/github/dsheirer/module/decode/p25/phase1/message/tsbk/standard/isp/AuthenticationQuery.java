 ...
 */
public class AuthenticationQuery extends ISPMessage
{
     ...
     */
    public AuthenticationQuery(P25P1DataUnitID dataUnitId, CorrectedBinaryMessage message, int nac, long timestamp)
    {
