...
public class SecondaryControlChannelBroadcastExplicit extends OSPMessage implements IFrequencyBandReceiver
{
    ...
    private static final IntField TRANSMIT_FREQUENCY_BAND = IntField.length4(32);
    private static final IntField TRANSMIT_CHANNEL_NUMBER = IntField.length12(36);
    private static final IntField RECEIVE_FREQUENCY_BAND = IntField.length4(56);
    private static final IntField RECEIVE_CHANNEL_NUMBER = IntField.length12(60);
