 ...
 */
public class StatusUpdateRequest extends ISPMessage
{
    private static final IntField UNIT_STATUS = IntField.length8(16);
    private static final IntField USER_STATUS = IntField.length8(24);
     ...
     */
    public StatusUpdateRequest(P25P1DataUnitID dataUnitId, CorrectedBinaryMessage message, int nac, long timestamp)
    {
