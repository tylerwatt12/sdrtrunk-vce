...
public class DecodeConfigNXDN extends DecodeConfiguration
{
    ...
    /**
     * Override the parent method to indicate 4800 or 9600 bits per second, depending on the mode.
     */
    @Override
    public int getBitRate()
    {
        return getTransmissionMode().getSymbolRate() * 2;
    }
    ...
    {
        return getChannelMode() == NXDNChannelMode.CONVENTIONAL;
    }
    ...
    {
        return getChannelMode() == NXDNChannelMode.TRUNKED;
    }
    ...
    public boolean isIgnoreEncryptedCalls()
    {
        return mIgnoreEncryptedCalls;
    }

    /**
     * Set ignore encrypted calls
     * @param ignore encrypted calls
     */
    ...
    {
        return switch(getTransmissionMode())
        {
            case M4800, TYPE_D -> CHANNEL_4800;
            case M9600 -> CHANNEL_9600;
        };
    }
}
