 ...
 * Call alert request
 */
public class CallAlertRequest extends ISPMessage
{
     ...
     */
    public CallAlertRequest(P25P1DataUnitID dataUnitId, CorrectedBinaryMessage message, int nac, long timestamp)
    {
