 ...
 * Queued response
 */
public class QueuedResponse extends OSPMessage
{
     ...
     */
    public QueuedResponse(P25P1DataUnitID dataUnitId, CorrectedBinaryMessage message, int nac, long timestamp)
    {
     ...
     */
    public Opcode getQueuedResponseServiceType()
    {
