 ...
 */
public class UnitRegistrationCommand extends OSPMessage
{
     ...
     */
    public UnitRegistrationCommand(P25P1DataUnitID dataUnitId, CorrectedBinaryMessage message, int nac, long timestamp)
    {
