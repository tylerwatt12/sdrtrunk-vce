 ...
 */
public class GroupAffiliationQuery extends OSPMessage
{
     ...
     */
    public GroupAffiliationQuery(P25P1DataUnitID dataUnitId, CorrectedBinaryMessage message, int nac, long timestamp)
    {
