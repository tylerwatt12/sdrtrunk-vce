    ...
    IChannelEventProvider, IMessageListener
{
    ...
    {
        if(timeslot == TimeslotMessage.TIMESLOT_2)
        {
        ...
        try
        {
            ...
            else
            {
                ...
                P25ChannelGrantEvent callEvent = P25ChannelGrantEvent.builder(decodeEventType, timestamp, serviceOptions)
                        .channelDescriptor(channelDescriptor)
                        .details(PHASE_1_CALL_DETAILS + (serviceOptions != null ? serviceOptions : ""))
                        .identifiers(mic)
                        .build();
                                            ...
                                            IdentifierCollection ic, long timestamp, String additionalDetails)
    {
        ...
        try
        {
            ...
            P25ChannelGrantEvent callEvent = P25ChannelGrantEvent.builder(decodeEventType, timestamp, serviceOptions)
                    .channelDescriptor(channelDescriptor)
                    .details(additionalDetails != null ? additionalDetails : PHASE_1_CALL_DETAILS +
                            (serviceOptions != null ? serviceOptions : ""))
                    .identifiers(ic)
                    .build();
        ...
        switch(macOpcode)
        {
            case PUSH_TO_TALK:
              ...
              case TDMA_01_GROUP_VOICE_CHANNEL_USER_ABBREVIATED,
                  TDMA_05_GROUP_VOICE_CHANNEL_GRANT_UPDATE_MULTIPLE_IMPLICIT,
                  TDMA_21_GROUP_VOICE_CHANNEL_USER_EXTENDED,
                  TDMA_25_GROUP_VOICE_CHANNEL_GRANT_UPDATE_MULTIPLE_EXPLICIT,
                  PHASE1_40_GROUP_VOICE_CHANNEL_GRANT_IMPLICIT,
                  PHASE1_42_GROUP_VOICE_CHANNEL_GRANT_UPDATE_IMPLICIT,
                  PHASE1_C0_GROUP_VOICE_CHANNEL_GRANT_EXPLICIT,
                  PHASE1_C3_GROUP_VOICE_CHANNEL_GRANT_UPDATE_EXPLICIT:
                type = encrypted ? DecodeEventType.CALL_GROUP_ENCRYPTED : DecodeEventType.CALL_GROUP;
                break;

            case MOTOROLA_80_GROUP_REGROUP_VOICE_CHANNEL_USER_ABBREVIATED,
                MOTOROLA_83_GROUP_REGROUP_VOICE_CHANNEL_UPDATE,
                PHASE1_90_GROUP_REGROUP_VOICE_CHANNEL_USER_ABBREVIATED,
                MOTOROLA_A0_GROUP_REGROUP_VOICE_CHANNEL_USER_EXTENDED,
                MOTOROLA_A3_GROUP_REGROUP_CHANNEL_GRANT_IMPLICIT,
                MOTOROLA_A4_GROUP_REGROUP_CHANNEL_GRANT_EXPLICIT,
                MOTOROLA_A5_GROUP_REGROUP_CHANNEL_GRANT_UPDATE,
                L3HARRIS_B0_GROUP_REGROUP_EXPLICIT_ENCRYPTION_COMMAND:
            ...
            case TDMA_02_UNIT_TO_UNIT_VOICE_CHANNEL_USER_ABBREVIATED,
                ...
                PHASE1_44_UNIT_TO_UNIT_VOICE_SERVICE_CHANNEL_GRANT_ABBREVIATED,
                PHASE1_46_UNIT_TO_UNIT_VOICE_CHANNEL_GRANT_UPDATE_ABBREVIATED,
                PHASE1_48_TELEPHONE_INTERCONNECT_VOICE_CHANNEL_GRANT_IMPLICIT,
                PHASE1_C4_UNIT_TO_UNIT_VOICE_SERVICE_CHANNEL_GRANT_EXTENDED_VCH,
                PHASE1_C6_UNIT_TO_UNIT_VOICE_CHANNEL_GRANT_UPDATE_EXTENDED_VCH,
                PHASE1_CF_UNIT_TO_UNIT_VOICE_SERVICE_CHANNEL_GRANT_EXTENDED_LCCH:
            ...
            case PHASE1_54_SNDCP_DATA_CHANNEL_GRANT,
                L3HARRIS_A0_PRIVATE_DATA_CHANNEL_GRANT,
                L3HARRIS_AC_UNIT_TO_UNIT_DATA_CHANNEL_GRANT:
                        ...
                        case NOTIFICATION_PROCESSING_START_REJECTED:
                            mAllocatedTrafficChannelMap.entrySet().stream()
                                    ...
                                    .ifPresent(rejectedFrequency -> {
                                        ...
                                        P25TrafficChannelEventTracker tracker = getTracker(rejectedFrequency, TimeslotMessage.TIMESLOT_1);
                        ...
                        case NOTIFICATION_PROCESSING_START_REJECTED:
                            mAllocatedTrafficChannelMap.entrySet().stream()
                                    ...
                                    .ifPresent(rejectedFrequency -> {
                                        ...
                                        //Leave the tracked event in the map so that it doesn't get recreated.  The channel
                                        //processing manager set the 'tuner not available' in the details already
                                        P25TrafficChannelEventTracker tracker2 = getTracker(rejectedFrequency, TimeslotMessage.TIMESLOT_2);
                                        if (tracker2 != null)
                                        {
                                            broadcast(tracker2);
                                        }
