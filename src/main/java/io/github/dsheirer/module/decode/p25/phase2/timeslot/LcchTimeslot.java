...
/**
 * Logical Control CHannel (LCCH) timeslot carrying an I-OECI message
 */
public class LcchTimeslot extends AbstractSignalingTimeslot
{
    ...
    /**
     * Constructs an un-scrambled LCCH timeslot
     *
     * @param message containing 320 scrambled bits for the timeslot
     * @param timeslot of the message
     * @param timestamp of the message
     */
    public LcchTimeslot(CorrectedBinaryMessage message, int timeslot, long timestamp)
    {
        super(message, DataUnitID.UNSCRAMBLED_LCCH, timeslot, timestamp);
    }
