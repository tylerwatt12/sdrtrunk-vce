 ...
 */
public class TelephoneInterconnectPstnRequest extends ISPMessage implements IServiceOptionsProvider
{
    private static final IntField SERVICE_OPTIONS = IntField.length8(16);
    private static final IntField PSTN_ADDRESS = IntField.length8(48);
