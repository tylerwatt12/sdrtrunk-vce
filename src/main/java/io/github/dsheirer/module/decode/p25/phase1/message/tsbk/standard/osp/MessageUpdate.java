 ...
 * Message update
 */
public class MessageUpdate extends OSPMessage
{
    private static final IntField MESSAGE = IntField.length16(16);
     ...
     */
    public MessageUpdate(P25P1DataUnitID dataUnitId, CorrectedBinaryMessage message, int nac, long timestamp)
    {
