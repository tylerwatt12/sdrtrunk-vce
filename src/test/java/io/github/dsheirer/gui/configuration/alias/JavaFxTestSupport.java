...
final class JavaFxTestSupport
{
    ...
    /** Drains both direct and one-level-deferred control notifications. */
    ...
    /**
     * Constructs dependencies that consult the process-wide portable path while it is safely pointed at a test root.
     */
