...
class WebUserPreferencesCodecTest
{
    ...
    void rejectsUnknownDuplicateAndNonIntegerFields()
    {
        assertThrows(java.io.IOException.class,
            () -> WebUserPreferencesCodec.decode(DEFAULT_JSON.replace("\"version\":1",
